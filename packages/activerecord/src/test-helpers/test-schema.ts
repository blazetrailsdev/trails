...
export const TEST_SCHEMA: Schema = {
  ...
  topics: {
    ...
    indexes: [{ columns: ["author_name", "title"] }],
  },
  ...
  sc3_books: { author_id: "integer", format_record_id: "integer", format_record_type: "string" },
  sc3_hardbacks: {},
  sc4_chefs: { department_id: "integer", employable_id: "integer", employable_type: "string" },
  sc4_depts: { hotel_id: "integer" },
  sc4_drinks: {},
  sc4_hotels: { name: "string" },
  sc4_recipes: { chef_id: "integer", hotel_id: "integer" },
  sc_cakes: {},
  sc_chefs: { department_id: "integer", employable_id: "integer", employable_type: "string" },

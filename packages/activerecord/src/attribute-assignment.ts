...
function _hasPrototypeSetter(obj: object, key: string): boolean {
...
export function _assignAttributes(
  ...
  for (const [k, v] of Object.entries(attributes)) {
    ...
    } else if (_hasPrototypeSetter(this as object, k)) {
      // Dispatch to prototype setter (e.g. *Ids writers generated by builder).
      // Mirrors Rails' _assign_attribute calling public_send("#{k}=", v).

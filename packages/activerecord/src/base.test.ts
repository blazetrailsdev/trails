...
// error classes tests moved to errors.test.ts

// hasAttribute() and attributeNames() tests moved to attribute-methods.test.ts

// previouslyNewRecord tests moved to persistence.test.ts

// frozen / isFrozen tests moved to core.test.ts

// columnNames tests moved to attribute-methods.test.ts

// humanAttributeName tests moved to attribute-methods.test.ts

// hasAttributeDefinition tests moved to attribute-methods.test.ts

// isBlank / isPresent tests moved to relation.test.ts

// Base.exists tests covered in finder.test.ts

// Base class aggregate delegates tests covered in calculations.test.ts

// ignoredColumns tests moved to attribute-methods.test.ts

// Base.new() tests moved to core.test.ts

// attributePresent() tests moved to attribute-methods.test.ts

// toKey() tests moved to core.test.ts

// attributesBeforeTypeCast tests moved to attribute-methods.test.ts

// columnForAttribute tests moved to attribute-methods.test.ts

// abstract_class tests moved to inheritance.test.ts
...
// Base#clone tests moved to clone.test.ts

// Base.columnDefaults tests moved to defaults.test.ts

// Base.findByAttribute tests moved to finder.test.ts

// Base.respondToMissingFinder tests moved to finder.test.ts

// Base.logger tests moved to core.test.ts

// Base.attributeTypes tests moved to attribute-methods.test.ts

// isPersisted tests covered in persistence.test.ts

// Base#isEqual tests moved to core.test.ts

// Base.pick tests covered in calculations.test.ts

// Base static query delegations tests moved to querying-methods-delegation.test.ts

// Base.columnsHash tests moved to attribute-methods.test.ts

// Base.contentColumns tests moved to attribute-methods.test.ts

// Base.inheritanceColumn tests moved to inheritance.test.ts

// "Base features (Rails-guided)" block split into per-feature files:
// - table naming tests kept in BasicsTest blocks above
// - primary key tests: primary-keys.test.ts
// - record state tests: persistence.test.ts (duplicates removed)
// - isFrozen tests: core.test.ts (duplicates removed)
// - hasAttribute/attributeNames/columnNames/columnsHash/contentColumns: attribute-methods.test.ts (duplicates removed)
// - inspect/slice/valuesAt/toParam/arelTable/adapter: core.test.ts


// "Rails-guided: New Features" block split into per-feature files:
// - pick: calculations.test.ts
// - first(n)/last(n): finder.test.ts
// - increment/decrement/toggle: persistence.test.ts
// - explain: explain.test.ts
// - union/intersect/except/joins/leftJoins/unionAll/lock: relations.test.ts
// - dependent destroy/delete, has_many through, collection proxy, includes: associations.test.ts
// - afterCommit: transaction-callbacks.test.ts
// - validates uniqueness: validations.test.ts
// - migrations: migration.test.ts

// Error Classes (Rails-guided) tests moved to errors.test.ts

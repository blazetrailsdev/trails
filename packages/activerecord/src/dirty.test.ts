...
//
// Needs a PG IDENTITY column (GENERATED BY DEFAULT AS IDENTITY);
// `cpk_postgresql_identity_table` is laid at boot from
// postgresql_specific_schema.rb:58-66. Rails' compound `PostgreSQLAdapter &&

 ...
 * through to the abstract `NotImplementedError` stub on sqlite3 and mysql2, so
 * the primitive was only reachable through the adapters' own `execute` paths.
 * These exercise it directly, on whichever adapter the lane runs.
 */

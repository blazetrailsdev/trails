 ...
 * activerecord-surfaced-deviations bucket (enum-canonical-book-gaps) via inline
 * pending comments below.
 */
...
describe("EnumTest", () => {
  ...
  it("query state with strings", () => {
    ...
    // in the activerecord-surfaced-deviations bucket (enum-canonical-book-gaps)
    // to avoid false fidelity.
  });
  ...
  it("build from scope", () => {
    ...
    // so that half is pending in the activerecord-surfaced-deviations bucket
    // (enum-canonical-book-gaps).
  });

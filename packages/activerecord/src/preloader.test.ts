...
describe("PreloaderTest", () => {
  ...
  it("preload makes correct number of queries on array", async () => {
    const adapter = freshAdapter();
    class PAuthor extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class PPost extends Base { static { this.attribute("title", "string"); this.attribute("p_author_id", "integer"); this.adapter = adapter; } }
    (PPost as any)._associations = [
      { type: "belongsTo", name: "pAuthor", options: { className: "PAuthor", foreignKey: "p_author_id" } },
    ];
  ...
  it("preload makes correct number of queries on relation", async () => {
    const adapter = freshAdapter();
    class PRAuthor extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class PRPost extends Base { static { this.attribute("title", "string"); this.attribute("pr_author_id", "integer"); this.adapter = adapter; } }
    (PRPost as any)._associations = [
      { type: "belongsTo", name: "prAuthor", options: { className: "PRAuthor", foreignKey: "pr_author_id" } },
    ];
  ...
  it("preload does not concatenate duplicate records", async () => {
    const adapter = freshAdapter();
    class PDAuthor extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class PDPost extends Base { static { this.attribute("title", "string"); this.attribute("pd_author_id", "integer"); this.adapter = adapter; } }
    (PDAuthor as any)._associations = [
      { type: "hasMany", name: "pdPosts", options: { className: "PDPost", foreignKey: "pd_author_id" } },
    ];
  ...
  it.skip("preload grouped queries of through records", () => { /* needs through-record grouping */ });
  it.skip("preload through records with already loaded middle record", () => { /* needs loaded-record merging */ });
  it.skip("preload with instance dependent scope", () => { /* needs instance-dependent scopes */ });
  it.skip("preload with instance dependent through scope", () => { /* needs instance-dependent scopes */ });
  it.skip("preload with through instance dependent scope", () => { /* needs instance-dependent scopes */ });

  it("some already loaded associations", async () => {
    const adapter = freshAdapter();
    class SAAuthor extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class SAPost extends Base { static { this.attribute("title", "string"); this.attribute("sa_author_id", "integer"); this.adapter = adapter; } }
    (SAPost as any)._associations = [
      { type: "belongsTo", name: "saAuthor", options: { className: "SAAuthor", foreignKey: "sa_author_id" } },
    ];
  ...
  it("preload through", async () => {
    const adapter = freshAdapter();
    class PTTag extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class PTTagging extends Base { static { this.attribute("pt_post_id", "integer"); this.attribute("pt_tag_id", "integer"); this.adapter = adapter; } }
    class PTPost extends Base { static { this.attribute("title", "string"); this.adapter = adapter; } }
    (PTPost as any)._associations = [
      { type: "hasMany", name: "ptTaggings", options: { className: "PTTagging", foreignKey: "pt_post_id" } },
      { type: "hasManyThrough", name: "ptTags", options: { through: "ptTaggings", source: "ptTag", className: "PTTag" } },
    ];
    (PTTagging as any)._associations = [
      { type: "belongsTo", name: "ptTag", options: { className: "PTTag", foreignKey: "pt_tag_id" } },
    ];
  ...
  it.skip("preload groups queries with same scope at second level", () => { /* needs multi-level scope grouping */ });
  it.skip("preload groups queries with same sql at second level", () => { /* needs multi-level scope grouping */ });
  it.skip("preload with grouping sets inverse association", () => { /* needs inverse association setting */ });
  it.skip("preload can group separate levels", () => { /* needs multi-level grouping */ });
  it.skip("preload can group multi level ping pong through", () => { /* needs multi-level through */ });
  it.skip("preload does not group same class different scope", () => { /* needs scope comparison */ });
  it.skip("preload does not group same scope different key name", () => { /* needs key name comparison */ });
  it.skip("multi database polymorphic preload with same table name", () => { /* needs multi-database */ });

  it("preload with available records", async () => {
    const adapter = freshAdapter();
    class PAAuthor extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class PAPost extends Base { static { this.attribute("title", "string"); this.attribute("pa_author_id", "integer"); this.adapter = adapter; } }
    (PAPost as any)._associations = [
      { type: "belongsTo", name: "paAuthor", options: { className: "PAAuthor", foreignKey: "pa_author_id" } },
    ];
  ...
  it.skip("preload with available records sti", () => { /* needs STI */ });

  it("preload with only some records available", async () => {
    const adapter = freshAdapter();
    class PSAuthor extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class PSPost extends Base { static { this.attribute("title", "string"); this.attribute("ps_author_id", "integer"); this.adapter = adapter; } }
    (PSPost as any)._associations = [
      { type: "belongsTo", name: "psAuthor", options: { className: "PSAuthor", foreignKey: "ps_author_id" } },
    ];
    ...
    const names = posts.map((p: any) => p._preloadedAssociations.get("psAuthor")?.readAttribute("name"));
  ...
  it("preload with some records already loaded", async () => {
    const adapter = freshAdapter();
    class PLAuthor extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class PLPost extends Base { static { this.attribute("title", "string"); this.attribute("pl_author_id", "integer"); this.adapter = adapter; } }
    (PLPost as any)._associations = [
      { type: "belongsTo", name: "plAuthor", options: { className: "PLAuthor", foreignKey: "pl_author_id" } },
    ];
  ...
  it.skip("preload with available records with through association", () => { /* needs through preload with available records */ });
  it.skip("preload with only some records available with through associations", () => { /* needs through preload */ });

  it("preload with available records with multiple classes", async () => {
    const adapter = freshAdapter();
    class PMAuthor extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class PMComment extends Base { static { this.attribute("body", "string"); this.attribute("pm_post_id", "integer"); this.adapter = adapter; } }
    class PMPost extends Base { static { this.attribute("title", "string"); this.attribute("pm_author_id", "integer"); this.adapter = adapter; } }
    (PMPost as any)._associations = [
      { type: "belongsTo", name: "pmAuthor", options: { className: "PMAuthor", foreignKey: "pm_author_id" } },
      { type: "hasMany", name: "pmComments", options: { className: "PMComment", foreignKey: "pm_post_id" } },
    ];
    ...
    expect(posts).toHaveLength(1);
    expect((posts[0] as any)._preloadedAssociations.get("pmAuthor").readAttribute("name")).toBe("Auth");
  });

  it.skip("preload with available records queries when scoped", () => { /* needs scoped preloading */ });
  it.skip("preload with available records queries when collection", () => { /* needs collection preloading */ });
  it.skip("preload with available records queries when incomplete", () => { /* needs incomplete record detection */ });

  it("preload with unpersisted records no ops", async () => {
    const adapter = freshAdapter();
    class PUAuthor extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class PUPost extends Base { static { this.attribute("title", "string"); this.attribute("pu_author_id", "integer"); this.adapter = adapter; } }
    (PUPost as any)._associations = [
      { type: "belongsTo", name: "puAuthor", options: { className: "PUAuthor", foreignKey: "pu_author_id" } },
    ];
    ...
    expect((post as any)._preloadedAssociations === undefined || (post as any)._preloadedAssociations.size === 0).toBe(true);
  });

  it("preload wont set the wrong target", async () => {
    const adapter = freshAdapter();
    class PWAuthor extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class PWPost extends Base { static { this.attribute("title", "string"); this.attribute("pw_author_id", "integer"); this.adapter = adapter; } }
    (PWPost as any)._associations = [
      { type: "belongsTo", name: "pwAuthor", options: { className: "PWAuthor", foreignKey: "pw_author_id" } },
    ];
  ...
  it.skip("preload has many association with composite foreign key", () => { /* needs composite keys */ });
  ...
  it("preload keeps built has many records no ops", async () => {
    const adapter = freshAdapter();
    class PKAuthor extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class PKPost extends Base { static { this.attribute("title", "string"); this.attribute("pk_author_id", "integer"); this.adapter = adapter; } }
    (PKAuthor as any)._associations = [
      { type: "hasMany", name: "pkPosts", options: { className: "PKPost", foreignKey: "pk_author_id" } },
    ];
  ...
  it("preload keeps built has many records after query", async () => {
    const adapter = freshAdapter();
    class PKQAuthor extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class PKQPost extends Base { static { this.attribute("title", "string"); this.attribute("pkq_author_id", "integer"); this.adapter = adapter; } }
    (PKQAuthor as any)._associations = [
      { type: "hasMany", name: "pkqPosts", options: { className: "PKQPost", foreignKey: "pkq_author_id" } },
    ];
  ...
  it("preload keeps built belongs to records no ops", async () => {
    const adapter = freshAdapter();
    class PKBAuthor extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class PKBPost extends Base { static { this.attribute("title", "string"); this.attribute("pkb_author_id", "integer"); this.adapter = adapter; } }
    (PKBPost as any)._associations = [
      { type: "belongsTo", name: "pkbAuthor", options: { className: "PKBAuthor", foreignKey: "pkb_author_id" } },
    ];
  ...
  it("preload keeps built belongs to records after query", async () => {
    const adapter = freshAdapter();
    class PKBAAuthor extends Base { static { this.attribute("name", "string"); this.adapter = adapter; } }
    class PKBAPost extends Base { static { this.attribute("title", "string"); this.attribute("pkba_author_id", "integer"); this.adapter = adapter; } }
    (PKBAPost as any)._associations = [
      { type: "belongsTo", name: "pkbaAuthor", options: { className: "PKBAAuthor", foreignKey: "pkba_author_id" } },
    ];

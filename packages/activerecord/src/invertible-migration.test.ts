...
describe("InvertibleMigrationTest", () => {
  ...
  // Tracked-pending-convergence under the activerecord-surfaced-deviations bucket.
  ...
  // convergence under the activerecord-surfaced-deviations bucket (revert-direction semantics).

...
class SchemaAdapter implements DatabaseAdapter {
  ...
  get arelVisitor(): Visitors.ToSql | undefined {
    // Phase 9b-2: all three adapters (SQLite #2127, PG #2139, MySQL here)
    // now delegate. The `relation.ts:3614-3619` dormant fallback is dead
    // code; Phase 9b-3+4 will delete it along with this SchemaAdapter.

...
export class TableDefinition extends AbstractTableDefinition {
  ...
  /**
   * @internal
   * @noRailsEquivalent CONVERGEABLE MySQL::Table/TableDefinition's define_column_methods macro (mysql/schema_definitions.rb:40); Ruby generates the methods, TS declares them.
   */

...
export class AssociationRelation<T extends Base> extends Relation<T> {
   ...
   *
   * @internal
   * @noRailsEquivalent PERMANENT Ruby's Object#clone is inherited; JS needs a declared override to keep the AssociationRelation subclass through spawn (relation/spawn_methods.rb:12).
   */

...
describe("PreloaderTest", () => {
  it.skip("preload with scope", () => { /* fixture-dependent */ });
  it.skip("preload makes correct number of queries on array", () => { /* fixture-dependent */ });
  it.skip("preload makes correct number of queries on relation", () => { /* fixture-dependent */ });
  it.skip("preload does not concatenate duplicate records", () => { /* fixture-dependent */ });
  it.skip("preload for hmt with conditions", () => { /* fixture-dependent */ });
  it.skip("preload groups queries with same scope", () => { /* fixture-dependent */ });
  it.skip("preload grouped queries with already loaded records", () => { /* fixture-dependent */ });
  it.skip("preload grouped queries of middle records", () => { /* fixture-dependent */ });
  it.skip("preload grouped queries of through records", () => { /* fixture-dependent */ });
  it.skip("preload through records with already loaded middle record", () => { /* fixture-dependent */ });
  it.skip("preload with instance dependent scope", () => { /* fixture-dependent */ });
  it.skip("preload with instance dependent through scope", () => { /* fixture-dependent */ });
  it.skip("preload with through instance dependent scope", () => { /* fixture-dependent */ });
  it.skip("some already loaded associations", () => { /* fixture-dependent */ });
  it.skip("preload through", () => { /* fixture-dependent */ });
  it.skip("preload groups queries with same scope at second level", () => { /* fixture-dependent */ });
  it.skip("preload groups queries with same sql at second level", () => { /* fixture-dependent */ });
  it.skip("preload with grouping sets inverse association", () => { /* fixture-dependent */ });
  it.skip("preload can group separate levels", () => { /* fixture-dependent */ });
  it.skip("preload can group multi level ping pong through", () => { /* fixture-dependent */ });
  it.skip("preload does not group same class different scope", () => { /* fixture-dependent */ });
  it.skip("preload does not group same scope different key name", () => { /* fixture-dependent */ });
  it.skip("multi database polymorphic preload with same table name", () => { /* fixture-dependent */ });
  it.skip("preload with available records", () => { /* fixture-dependent */ });
  it.skip("preload with available records sti", () => { /* fixture-dependent */ });
  it.skip("preload with only some records available", () => { /* fixture-dependent */ });
  it.skip("preload with some records already loaded", () => { /* fixture-dependent */ });
  it.skip("preload with available records with through association", () => { /* fixture-dependent */ });
  it.skip("preload with only some records available with through associations", () => { /* fixture-dependent */ });
  it.skip("preload with available records with multiple classes", () => { /* fixture-dependent */ });
  it.skip("preload with available records queries when scoped", () => { /* fixture-dependent */ });
  it.skip("preload with available records queries when collection", () => { /* fixture-dependent */ });
  it.skip("preload with available records queries when incomplete", () => { /* fixture-dependent */ });
  it.skip("preload with unpersisted records no ops", () => { /* fixture-dependent */ });
  it.skip("preload wont set the wrong target", () => { /* fixture-dependent */ });
  it.skip("preload has many association with composite foreign key", () => { /* fixture-dependent */ });
  it.skip("preload belongs to association with composite foreign key", () => { /* fixture-dependent */ });
  it.skip("preload loaded belongs to association with composite foreign key", () => { /* fixture-dependent */ });
  it.skip("preload has many through association with composite query constraints", () => { /* fixture-dependent */ });
  it.skip("preloads has many on model with a composite primary key through id attribute", () => { /* fixture-dependent */ });
  it.skip("preloads belongs to a composite primary key model through id attribute", () => { /* fixture-dependent */ });
  it.skip("preload keeps built has many records no ops", () => { /* fixture-dependent */ });
  it.skip("preload keeps built has many records after query", () => { /* fixture-dependent */ });
  it.skip("preload keeps built belongs to records no ops", () => { /* fixture-dependent */ });
  it.skip("preload keeps built belongs to records after query", () => { /* fixture-dependent */ });
});
...
describe("AssociationsTest", () => {
  ...
  it.skip("loading the association target should keep child records marked for destruction", () => { /* fixture-dependent */ });
  ...
  it.skip("bad collection keys", () => { /* fixture-dependent */ });
  it.skip("should construct new finder sql after create", () => { /* fixture-dependent */ });
  it.skip("force reload", () => { /* fixture-dependent */ });
...
describe("InheritanceTest", () => {
  ...
  it.skip("compute type no method error", () => { /* fixture-dependent */ });
  it.skip("compute type on undefined method", () => { /* fixture-dependent */ });
  ...
  it.skip("base class activerecord error", () => { /* fixture-dependent */ });
...
describe("OrTest", () => {
  it.skip("or identity", () => { /* fixture-dependent */ });
  it.skip("or with null left", () => { /* fixture-dependent */ });
  it.skip("or with null right", () => { /* fixture-dependent */ });
  it.skip("or with large number", () => { /* fixture-dependent */ });
  it.skip("or with bind params", () => { /* fixture-dependent */ });
  it.skip("or with null both", () => { /* fixture-dependent */ });
  it.skip("or without left where", () => { /* fixture-dependent */ });
  it.skip("or without right where", () => { /* fixture-dependent */ });
  it.skip("or with incompatible single value relations", () => { /* fixture-dependent */ });
  it.skip("or with incompatible multi value relations", () => { /* fixture-dependent */ });
  it.skip("or with unscope where", () => { /* fixture-dependent */ });
  it.skip("or with unscope where column", () => { /* fixture-dependent */ });
  it.skip("or with unscope order", () => { /* fixture-dependent */ });
  it.skip("or with incompatible unscope", () => { /* fixture-dependent */ });
  it.skip("or when grouping", () => { /* fixture-dependent */ });
  it.skip("or with named scope", () => { /* fixture-dependent */ });
  it.skip("or inside named scope", () => { /* fixture-dependent */ });
  it.skip("or with sti relation", () => { /* fixture-dependent */ });
  it.skip("or on loaded relation", () => { /* fixture-dependent */ });
  it.skip("or with non relation object raises error", () => { /* fixture-dependent */ });
  it.skip("or with references inequality", () => { /* fixture-dependent */ });
  it.skip("or with scope on association", () => { /* fixture-dependent */ });
  it.skip("or with annotate", () => { /* fixture-dependent */ });
  it.skip("structurally incompatible values", () => { /* fixture-dependent */ });
});
...
describe("SelectTest", () => {
  it.skip("select with nil argument", () => { /* fixture-dependent */ });
  it.skip("select with non field values", () => { /* fixture-dependent */ });
  it.skip("select with non field hash values", () => { /* fixture-dependent */ });
  it.skip("select with hash argument", () => { /* fixture-dependent */ });
  it.skip("select with reserved words aliases", () => { /* fixture-dependent */ });
  it.skip("select with one level hash argument", () => { /* fixture-dependent */ });
  it.skip("select with not exists field", () => { /* fixture-dependent */ });
  it.skip("select with hash with not exists field", () => { /* fixture-dependent */ });
  it.skip("select with hash array value with not exists field", () => { /* fixture-dependent */ });
  it.skip("select with hash and table alias", () => { /* fixture-dependent */ });
  it.skip("select with invalid nested field", () => { /* fixture-dependent */ });
  it.skip("select with hash argument without aliases", () => { /* fixture-dependent */ });
  it.skip("select with hash argument with few tables", () => { /* fixture-dependent */ });
  it.skip("reselect", () => { /* fixture-dependent */ });
  it.skip("reselect with hash argument", () => { /* fixture-dependent */ });
  it.skip("reselect with one level hash argument", () => { /* fixture-dependent */ });
  it.skip("non select columns wont be loaded", () => { /* fixture-dependent */ });
  it.skip("merging select from different model", () => { /* fixture-dependent */ });
  it.skip("type casted extra select with eager loading", () => { /* fixture-dependent */ });
  it.skip("aliased select using as with joins and includes", () => { /* fixture-dependent */ });
  it.skip("aliased select not using as with joins and includes", () => { /* fixture-dependent */ });
  it.skip("star select with joins and includes", () => { /* fixture-dependent */ });
  it.skip("select without any arguments", () => { /* fixture-dependent */ });
});

describe("UpdateAllTest", () => {
  it.skip("update all with scope", () => { /* fixture-dependent */ });
  it.skip("update all with non standard table name", () => { /* fixture-dependent */ });
  it.skip("update all with blank argument", () => { /* fixture-dependent */ });
  it.skip("update all with group by", () => { /* fixture-dependent */ });
  it.skip("update all with joins", () => { /* fixture-dependent */ });
  it.skip("update all with left joins", () => { /* fixture-dependent */ });
  it.skip("update all with includes", () => { /* fixture-dependent */ });
  it.skip("update all with joins and limit and order", () => { /* fixture-dependent */ });
  it.skip("update all with joins and offset and order", () => { /* fixture-dependent */ });
  it.skip("update counters with joins", () => { /* fixture-dependent */ });
  it.skip("touch all with aliased for update timestamp", () => { /* fixture-dependent */ });
  it.skip("touch all with given time", () => { /* fixture-dependent */ });
  it.skip("update on relation", () => { /* fixture-dependent */ });
  it.skip("update with ids on relation", () => { /* fixture-dependent */ });
  it.skip("update on relation passing active record object is not permitted", () => { /* fixture-dependent */ });
  it.skip("update bang on relation", () => { /* fixture-dependent */ });
  it.skip("update all cares about optimistic locking", () => { /* fixture-dependent */ });
  it.skip("update counters cares about optimistic locking", () => { /* fixture-dependent */ });
  it.skip("touch all cares about optimistic locking", () => { /* fixture-dependent */ });
  it.skip("klass level update all", () => { /* fixture-dependent */ });
  it.skip("klass level touch all", () => { /* fixture-dependent */ });
  it.skip("update all composite model with join subquery", () => { /* fixture-dependent */ });
  it.skip("update all ignores order without limit from association", () => { /* fixture-dependent */ });
});
...
describe("CoreTest", () => {
  it.skip("inspect class", () => { /* fixture-dependent */ });
  it.skip("inspect includes attributes from attributes for inspect", () => { /* fixture-dependent */ });
  it.skip("inspect instance with lambda date formatter", () => { /* fixture-dependent */ });
  it.skip("inspect singleton instance", () => { /* fixture-dependent */ });
  it.skip("inspect limited select instance", () => { /* fixture-dependent */ });
  it.skip("inspect instance with non primary key id attribute", () => { /* fixture-dependent */ });
  it.skip("inspect class without table", () => { /* fixture-dependent */ });
  it.skip("inspect with attributes for inspect all lists all attributes", () => { /* fixture-dependent */ });
  it.skip("inspect relation with virtual field", () => { /* fixture-dependent */ });
  it.skip("inspect with overridden attribute for inspect", () => { /* fixture-dependent */ });
  it.skip("full inspect lists all attributes", () => { /* fixture-dependent */ });
  it.skip("pretty print new", () => { /* fixture-dependent */ });
  it.skip("pretty print persisted", () => { /* fixture-dependent */ });
  it.skip("pretty print full", () => { /* fixture-dependent */ });
  it.skip("pretty print uninitialized", () => { /* fixture-dependent */ });
  it.skip("pretty print overridden by inspect", () => { /* fixture-dependent */ });
  it.skip("pretty print with non primary key id attribute", () => { /* fixture-dependent */ });
  it.skip("pretty print with overridden attribute for inspect", () => { /* fixture-dependent */ });
  it.skip("find by cache does not duplicate entries", () => { /* fixture-dependent */ });
  it.skip("composite pk models added to a set", () => { /* fixture-dependent */ });
...
describe("DeleteAllTest", () => {
  it.skip("delete all with index hint", () => { /* fixture-dependent */ });
  it.skip("delete all loaded", () => { /* fixture-dependent */ });
  it.skip("delete all with group by and having", () => { /* fixture-dependent */ });
  it.skip("delete all with unpermitted relation raises error", () => { /* fixture-dependent */ });
  it.skip("delete all with joins and where part is hash", () => { /* fixture-dependent */ });
  it.skip("delete all with joins and where part is not hash", () => { /* fixture-dependent */ });
  it.skip("delete all with left joins", () => { /* fixture-dependent */ });
  it.skip("delete all with includes", () => { /* fixture-dependent */ });
  it.skip("delete all with order and limit deletes subset only", () => { /* fixture-dependent */ });
  it.skip("delete all with order and limit and offset deletes subset only", () => { /* fixture-dependent */ });
  it.skip("delete all composite model with join subquery", () => { /* fixture-dependent */ });
});
...
describe("TestAutosaveAssociationsInGeneral", () => {
  it.skip("autosave works even when other callbacks update the parent model", () => { /* fixture-dependent */ });
  it.skip("autosave does not pass through non custom validation contexts", () => { /* fixture-dependent */ });
  it.skip("autosave collection association callbacks get called once", () => { /* fixture-dependent */ });
  it.skip("autosave has one association callbacks get called once", () => { /* fixture-dependent */ });
  it.skip("autosave belongs to association callbacks get called once", () => { /* fixture-dependent */ });
  it.skip("should not add the same callbacks multiple times for has one", () => { /* fixture-dependent */ });
  it.skip("should not add the same callbacks multiple times for belongs to", () => { /* fixture-dependent */ });
  it.skip("should not add the same callbacks multiple times for has many", () => { /* fixture-dependent */ });
  it.skip("should not add the same callbacks multiple times for has and belongs to many", () => { /* fixture-dependent */ });
  it.skip("cyclic autosaves do not add multiple validations", () => { /* fixture-dependent */ });
});
...
describe("ExcludingTest", () => {
  it.skip("result set does not include collection of excluded records from a query", () => { /* fixture-dependent */ });
  it.skip("result set does not include collection of excluded records from a loaded query", () => { /* fixture-dependent */ });
  it.skip("result set does not include collection of excluded records and queries", () => { /* fixture-dependent */ });
  it.skip("result set through association does not include single excluded record", () => { /* fixture-dependent */ });
  it.skip("result set through association does not include collection of excluded records", () => { /* fixture-dependent */ });
  it.skip("result set through association does not include collection of excluded records from a relation", () => { /* fixture-dependent */ });
  it.skip("result set through association does not include collection of excluded records from a loaded relation", () => { /* fixture-dependent */ });
  it.skip("raises on record from different class", () => { /* fixture-dependent */ });
});
...
describe("TestAutosaveAssociationValidationMethodsGeneration", () => {
  it.skip("should generate validation methods for has_many associations", () => { /* fixture-dependent */ });
  it.skip("should generate validation methods for has_one associations with :validate => true", () => { /* fixture-dependent */ });
  it.skip("should not generate validation methods for has_one associations without :validate => true", () => { /* fixture-dependent */ });
  it.skip("should generate validation methods for belongs_to associations with :validate => true", () => { /* fixture-dependent */ });
  it.skip("should not generate validation methods for belongs_to associations without :validate => true", () => { /* fixture-dependent */ });
  it.skip("should generate validation methods for HABTM associations with :validate => true", () => { /* fixture-dependent */ });
});
...
describe("NullRelationTest", () => {
  it.skip("none chainable to existing scope extension method", () => { /* fixture-dependent */ });
  it.skip("async query on null relation", () => { /* fixture-dependent */ });
  it.skip("none chained to methods firing queries straight to db", () => { /* fixture-dependent */ });
  it.skip("null relation used with constraints", () => { /* fixture-dependent */ });
  it.skip("null relation metadata methods", () => { /* fixture-dependent */ });
  it.skip("null relation in where condition", () => { /* fixture-dependent */ });
});
...
describe("HasManyAssociationsTestPrimaryKeys", () => {
  ...
  it.skip("association primary key on new record should fetch with query", () => { /* fixture-dependent */ });
  it.skip("ids on unloaded association with custom primary key", () => { /* fixture-dependent */ });
  it.skip("ids on loaded association with custom primary key", () => { /* fixture-dependent */ });
...
describe("TestDefaultAutosaveAssociationOnNewRecord", () => {
  it.skip("autosave new record on belongs to can be disabled per relationship", () => { /* fixture-dependent */ });
  it.skip("autosave new record on has one can be disabled per relationship", () => { /* fixture-dependent */ });
  it.skip("autosave new record on has many can be disabled per relationship", () => { /* fixture-dependent */ });
  it.skip("autosave new record with after create callback", () => { /* fixture-dependent */ });
  it.skip("autosave new record with after create callback and habtm association", () => { /* fixture-dependent */ });
});
...
describe("StructuralCompatibilityTest", () => {
  it.skip("compatible values", () => { /* fixture-dependent */ });
  it.skip("incompatible single value relations", () => { /* fixture-dependent */ });
  it.skip("incompatible multi value relations", () => { /* fixture-dependent */ });
  it.skip("incompatible unscope", () => { /* fixture-dependent */ });
});
...
describe("OrderTest", () => {
  it.skip("order asc", () => { /* fixture-dependent */ });
  it.skip("order desc", () => { /* fixture-dependent */ });
  it.skip("order with association", () => { /* fixture-dependent */ });
  it.skip("order with association alias", () => { /* fixture-dependent */ });
});
...
describe("AndTest", () => {
  it.skip("and", () => { /* fixture-dependent */ });
  it.skip("and with non relation attribute", () => { /* fixture-dependent */ });
  it.skip("and with structurally incompatible scope", () => { /* fixture-dependent */ });
});
...
describe("TestAutosaveAssociationOnAHasOneThroughAssociation", () => {
  it.skip("should not has one through model", () => { /* fixture-dependent */ });
  it.skip("should not reversed has one through model", () => { /* fixture-dependent */ });
});
...
describe("TestAutosaveAssociationOnAHasManyAssociationWithInverse", () => {
  it.skip("after save callback with autosave", () => { /* fixture-dependent */ });
});
...
describe("ExplicitlyNamedIndexMigrationTest", () => {
  it.skip("drop index by name", () => { /* fixture-dependent */ });
});
...
describe("TestAutosaveAssociationOnABelongsToAssociationDefinedAsRecord", () => {
  it.skip("should not raise error", () => { /* fixture-dependent */ });
});
...
describe("TestAutosaveAssociationWithTouch", () => {
  it.skip("autosave with touch should not raise system stack error", () => { /* fixture-dependent */ });
});
...
describe("TestAutosaveAssociationOnAHasManyAssociationDefinedInSubclassWithAcceptsNestedAttributes", () => {
  it.skip("should update children when association redefined in subclass", () => { /* fixture-dependent */ });
});
...
describe("can use symbols as object identifier", () => {
  it.skip("can use symbols as object identifier", () => { /* fixture-dependent */ });
});

describe("numeric column changes from zero to no empty string", () => {
  it.skip("numeric column changes from zero to no empty string", () => { /* fixture-dependent */ });
});
...
describe("should automatically build new associated models for each entry in a hash where the id is missing", () => {
  it.skip("should automatically build new associated models for each entry in a hash where the id is missing", () => { /* fixture-dependent */ });
});
...
describe("should automatically save the associated models", () => {
  it.skip("should automatically save the associated models", () => { /* fixture-dependent */ });
});
...
describe("should raise an argument error if something else than a hash is passed", () => {
  it.skip("should raise an argument error if something else than a hash is passed", () => { /* fixture-dependent */ });
});
...
describe("should save only one association on create", () => {
  it.skip("should save only one association on create", () => { /* fixture-dependent */ });
});
...
describe("should take a hash and assign the attributes to the associated models", () => {
  it.skip("should take a hash and assign the attributes to the associated models", () => { /* fixture-dependent */ });
});
...
describe("should take an array and assign the attributes to the associated models", () => {
  it.skip("should take an array and assign the attributes to the associated models", () => { /* fixture-dependent */ });
});

describe("should update children when autosave is true and parent is new but child is not", () => {
  it.skip("should update children when autosave is true and parent is new but child is not", () => { /* fixture-dependent */ });
});
...
describe("not respond to arel method", () => {
  it.skip("not respond to arel method", () => { /* fixture-dependent */ });
});

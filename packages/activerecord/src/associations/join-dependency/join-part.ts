...
export abstract class JoinPart {
   ...
   * @internal
   * @noRailsEquivalent CONVERGEABLE stored form of JoinPart#table (join_dependency/join_part.rb:20), which Ruby recomputes off the base_klass each read.
   */
  ...
  /**
   * @internal
   * @noRailsEquivalent CONVERGEABLE stored form of JoinAssociation#reflection (join_dependency/join_association.rb:9), kept on the part so Aliases can read it.
   */

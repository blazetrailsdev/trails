...
describe("HasManyAssociationsTest", () => {
  ...
  // nullified. The association-layer `delete` (CollectionAssociation#delete) is
  // the dependent-aware path; the CollectionProxy short-circuits non-through
  // deletes to a nullify.

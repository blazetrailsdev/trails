...
import { PoolConfig, type SQLite3Config } from "../connection-adapters/pool-config.js";
...
export function newSqlitePool(database = ":memory:", options?: SQLite3Config): ConnectionPool {

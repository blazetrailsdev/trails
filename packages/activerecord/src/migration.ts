...
export interface MigrationArConfig {
  ...
  // Sync: since trails' `leaseConnection` is now async (awaits per-checkout
  // `verifyBang`), this returns the *already-leased* connection and cannot
  // establish a new one synchronously.

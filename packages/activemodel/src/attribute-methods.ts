...
export function aliasAttributeMethodDefinition(
  ...
  // method — matching how `attribute()` defines readers — so it does not collide
  // with anything and, defined here rather than inline in `aliasAttribute`, it is
  // regenerated by `defineAttributeMethods` after `undefineAttributeMethods`.

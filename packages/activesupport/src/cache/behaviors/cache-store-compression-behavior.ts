...
/**
 * @internal
 * @noRailsEquivalent PERMANENT Ruby spells this `include CacheStoreCompressionBehavior`
 * (activesupport/test/cache/behaviors/cache_store_compression_behavior.rb); TS has no `include` for a test

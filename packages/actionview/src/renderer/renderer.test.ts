...
describe("Renderer dispatch", () => {
  ...
  it("routes to TemplateRenderer when no partial: key is present", () => {
    const spy = vi.spyOn(TemplateRenderer.prototype, "render").mockImplementation(() => {
  ...
  it("routes to PartialRenderer for string partial without collection or object", () => {
    const spy = vi.spyOn(PartialRenderer.prototype, "render").mockImplementation(() => {
  ...
  it("routes to CollectionRenderer for string partial with collection:", () => {
    const spy = vi
      .spyOn(CollectionRenderer.prototype, "renderCollectionWithPartial")
      .mockImplementation(() => {
  ...
  it("routes to ObjectRenderer for string partial with object:", () => {
    const spy = vi
      .spyOn(ObjectRenderer.prototype, "renderObjectWithPartial")
      .mockImplementation(() => {
  ...
  it("routes to CollectionRenderer for object partial with toAry()", () => {
    const spy = vi
      .spyOn(CollectionRenderer.prototype, "renderCollectionDerivePartial")
      .mockImplementation(() => {
  ...
  it("routes to ObjectRenderer for object partial without toAry()", () => {
    const spy = vi
      .spyOn(ObjectRenderer.prototype, "renderObjectDerivePartial")
      .mockImplementation(() => {

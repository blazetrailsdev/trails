...
| ---------------------------- | ----------------------------------------------------------------------------- | ------------------ | ---------------------------------------------------------- |
| `@rails-ts/arel`             | [Arel](https://api.rubyonrails.org/classes/Arel.html)                         | **94.1%**          | SQL AST builder and query generation                       |
...
| `@rails-ts/rack`             | [Rack](https://rack.github.io/)                                               | **91.3%**          | Modular web server interface, request/response, middleware |
...
| `@rails-ts/activesupport`    | [ActiveSupport](https://api.rubyonrails.org/classes/ActiveSupport.html)       | **51.7%**          | Core utilities, inflection, caching, notifications         |
...
**61.6%** complete — 10,576 tests matched against 17,172 Rails tests.

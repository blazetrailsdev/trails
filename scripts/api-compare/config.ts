 ...
 * with `compareApi: false` are filtered out — they're vendored for
 * test-compare but not yet wired into extract-ruby-api.rb. Currently no
 * sources set the flag; rack and globalid are both api-compared.
 */

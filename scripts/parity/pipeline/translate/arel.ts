 ...
 *   tsx scripts/parity/pipeline/translate/arel.ts [--fixture arel-XX] [--dry-run] [--force]
 *
...
const FIXTURES_DIR = "scripts/parity/pipeline/fixtures";
...
function usage(): never {
  process.stderr.write(
    "Usage: tsx scripts/parity/pipeline/translate/arel.ts [--fixture arel-XX] [--dry-run] [--force]\n",
  );
  process.exit(1);
}

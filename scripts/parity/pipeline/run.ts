/**
 * Usage: tsx scripts/parity/pipeline/run.ts
 ...
 *   schema:  scripts/parity/pipeline/.out/{rails,trails}/         (legacy location — CI
 *            artifacts and schema-parity scripts depend on these exact paths)
 *   query:   scripts/parity/pipeline/.out/query/{rails,trails}/
 *
 * Modes:
...
const GEMFILE = "scripts/parity/pipeline/schema/ruby/Gemfile";
...
function parityTypeConfig(type: ParityType): TypeConfig {
  if (type === "schema") {
    return {
      ...
      outRails: "scripts/parity/pipeline/.out/rails",
      outTrails: "scripts/parity/pipeline/.out/trails",
      rubyDump: "scripts/parity/pipeline/schema/ruby/dump.rb",
      nodeDump: "scripts/parity/pipeline/schema/node/dump.ts",
      diffScript: "scripts/parity/pipeline/schema/diff.ts",
      extraDumpArgs: [],
    };
  }
  ...
  return {
    ...
    outRails: "scripts/parity/pipeline/.out/query/rails",
    outTrails: "scripts/parity/pipeline/.out/query/trails",
    rubyDump: "scripts/parity/pipeline/query/ruby/dump.rb",
    nodeDump: "scripts/parity/pipeline/query/node/dump.ts",
    diffScript: "scripts/parity/pipeline/query/diff.ts",
...
const AR_RUBY_DUMP = "scripts/parity/pipeline/query/ruby/ar_dump.rb";
const AR_NODE_DUMP = "scripts/parity/pipeline/query/node/ar_dump.ts";

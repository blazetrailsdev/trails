...
```sh
cd scripts/parity/pipeline/schema/ruby
...
bundle exec --gemfile scripts/parity/pipeline/schema/ruby/Gemfile \
  ruby scripts/parity/pipeline/schema/ruby/dump.rb \
  scripts/parity/pipeline/fixtures/01-trivial \
  /tmp/rails-01.json
```
...
```sh
bundle exec --gemfile scripts/parity/pipeline/schema/ruby/Gemfile \
  ruby scripts/parity/pipeline/schema/ruby/canonicalize_test.rb
```

// Wave 7: generate scripts/parity/pipeline/schema/ruby/Gemfile from vendor/sources.ts
...
// writeLockfile. Called from scripts/parity/pipeline/run.ts before any rails-side
...
export function buildGemfileContent(): string {
  ...
  return [
    ...
    "#",
    "# GENERATED from vendor/sources.ts by scripts/parity/pipeline/schema/ruby/build-gemfile.ts.",

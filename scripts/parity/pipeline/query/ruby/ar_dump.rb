...
#   bundle exec --gemfile scripts/parity/pipeline/schema/ruby/Gemfile \
#     ruby scripts/parity/pipeline/query/ruby/ar_dump.rb <fixture-dir> <out.json> \
#     [--frozen-at ISO8601_UTC_Z]
#
# Like scripts/parity/pipeline/query/ruby/dump.rb but tailored to ActiveRecord
...
def usage
  warn "Usage: bundle exec --gemfile scripts/parity/pipeline/schema/ruby/Gemfile ruby scripts/parity/pipeline/query/ruby/ar_dump.rb <fixture-dir> <out.json> [--frozen-at ISO8601_UTC_Z]"
  exit 1
end

 ...
 *   tsx scripts/parity/pipeline/query/node/dump.ts <fixture-dir> <out.json>
...
function usage(): never {
  process.stderr.write(
    "Usage: tsx scripts/parity/pipeline/query/node/dump.ts <fixture-dir> <out.json> [--frozen-at ISO8601_UTC_Z]\n",
  );
  process.exit(1);
}
...
// Shape check: ISO 8601 UTC with trailing Z. Matches scripts/parity/pipeline/canonical/

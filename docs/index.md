...
| [`shared-adapter-test-suite-plan.md`](shared-adapter-test-suite-plan.md) | P2       | M    | Run the shared AR test suite against sqlite3/postgresql/mysql2 (Rails-style `ARCONN` axis). 7 infra PRs then rolling skip-peeling. Triples effective Rails-test coverage per CI run.                                                     |

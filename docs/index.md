...
| [`fixtures-adoption-plan.md`](activerecord/fixtures-adoption-plan.md)                           | P1       | L    | Migrate AR tests from inline `defineSchema` + `Model.create` setup to `useFixtures([...])`. Phase B canary shipped (#2318, #2391); D-1 progress is the true gate. |
| [`connection-pooled-test-adapter-plan.md`](activerecord/connection-pooled-test-adapter-plan.md) | P1       | M    | Pool epic. Phase B/C shipped (#2242/#2245); D-X (PG+MySQL) closed; D-Y (#2372) shipped; D-1..N codemod sweep in flight; Phases E/F open.                          |
...
| [`adapter-cleanup-plan.md`](activerecord/adapter-cleanup-plan.md)                               | P1       | S    | Adapter→Connection collapse. Phases 1–2 shipped; 3 remaining PRs (A/B/C) gated on Phase G.                                                                        |
...
| [`activerecord-test-compare-100.md`](activerecord/activerecord-test-compare-100.md)             | P1       | L    | Road to 100% test:compare for activerecord. Per-file skip inventory and prioritized un-skip plan.                                                                 |

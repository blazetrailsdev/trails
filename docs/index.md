...
| [`activemodel-callbacks-convergence-plan.md`](activemodel-callbacks-convergence-plan.md) | P1       | —    | **Convergence complete.** PRs 1–7 merged. Two small followups remain: `autosaveBelongsTo` ordering (~30 LOC) and `hasTransactionalCallbacks` regression test (~20 LOC).                         |

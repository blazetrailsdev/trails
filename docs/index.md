...
| [`fixtures-adoption-plan.md`](activerecord/fixtures-adoption-plan.md)                           | P1       | S    | Migrate AR tests to `useFixtures([...])`. Phases A+B shipped; 5 Tier 1 files remain; adopt opportunistically. Phases C–F outstanding.   |
| [`connection-pooled-test-adapter-plan.md`](activerecord/connection-pooled-test-adapter-plan.md) | —        | —    | Pool epic — **complete 2026-05-28**. Archive only; see `adapter-cleanup-plan.md` for remaining follow-ups.                              |

...
**This doc is the strategy + vocabulary reference.** Active work — current slots, in-flight PRs, sized open work — lives in [`activerecord-100-plan.md`](activerecord-100-plan.md). Read this doc when you're starting fresh and need to understand _how_ we work; read the other doc when you want to pick up _what_ needs doing today.
...
- [`activerecord-100-plan.md`](activerecord-100-plan.md) — current work tracker: in-flight PRs, open audit clusters, sized slots, post-merge fidelity followups.

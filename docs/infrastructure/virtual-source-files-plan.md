...
| `this.enum(attr, map, opts?)` / `Class.enum(...)`               | per-value: `declare is<Value>: () => boolean; declare <value>Bang: () => Promise<true \| undefined>; declare static <value>: () => Relation<ThisClass>; declare static not<Value>: () => Relation<ThisClass>;` | `Base.enum` shape; honors `prefix` / `suffix` options                                                |
...
- **Enum value-label union types** — `this.enum("status", { draft: 0, published: 1 })`
